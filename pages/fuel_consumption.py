...
dash.register_page(__name__, path="/fuelconsp_graph")
...
@callback(Output("fuelconsp-live-graph", "figure"), [Input("fuelconsp-graph-update", "n_intervals")])
def update_graph(n):
    #generating the data
    # x_data = list(range(len(fuelconspFigs)))
    # fuelconspFigs.append(LiveData.fuel_rate_live())
    # y_data = fuelconspFigs
    ...
    # Create the graph
    layout = go.Layout(
        title="Fuel Consumption Live Graph",
